...
public class LambdaMain2 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // Predicate를 활용하여서
        // 정수를 받아서
        // 100~1000 사이의 정수이면서 짝수면 true 아니면 false
        // 람다식을 작성하세요
        Predicate<Integer> validator = n -> n > 100 && n < 1000 && n % 2 == 0;
        System.out.println(validator.test(200));

        List<String> names = List.of("김철수", "박철수", "김영희", "을지문덕");
        List<String> kims = filter(names, s -> s.startsWith("김"));
        System.out.println(kims);
        // 우리가만든 filter로 3글자 초과하는 이름만 List로 추출
